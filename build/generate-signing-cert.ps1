param([string]$CertName = "HintOverlay", [string]$CertPath = "$PSScriptRoot\..\certs\HintOverlay_CodeSign.pfx", [string]$CertPassword = "HintOverlay_BuildCert_2024", [int]$ValidYears = 10, [switch]$Force)
