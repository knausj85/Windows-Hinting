param([string]$CertName = "WindowsHinting", [string]$CertPath = "$PSScriptRoot\..\certs\WindowsHinting_CodeSign.pfx", [string]$CertPassword = "WindowsHinting_BuildCert_2024", [int]$ValidYears = 10, [switch]$Force)
